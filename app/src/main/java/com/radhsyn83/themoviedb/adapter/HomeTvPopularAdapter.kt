...
class HomeTvPopularAdapter(
    val context: Context,
    val data: ArrayList<HomeTvPopularModel.Result>,
    val listener: Listener
) : RecyclerView.Adapter<HomeTvPopularAdapter.ViewHolder>() {

    val movies: ArrayList<HomeTvPopularModel.Result> = data

    interface Listener {
        fun onItemClicked(data: HomeTvPopularModel.Result)
    }

    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bindView(result: HomeTvPopularModel.Result) {
    ...
    fun addItem(movieNew: ArrayList<HomeTvPopularModel.Result>) {
        movies.clear()
